window.testdata = function () {
    ...
    function createSuite(parent, element, strings, index) {
        ...
        console.log("parent:"+parent+" statusElement:"+statusElement+" strings:"+strings+" index:"+index);
        console.log("id:"+'s' + ((index || 0) + 1));
        console.log("name:"+strings.get(element[0]));
        console.log("source:"+strings.get(element[1]));
        console.log("relativeSource:"+strings.get(element[2]));
        var docTest = (function () {
                                      var doc = strings.get(element[3]);
                                      this.doc = function () { return doc; };
                                      return doc;
                                  })();
        console.log("doc:"+docTest);
    ...
    function suite() {
        ...
        console.log("elem got from data.js is:");
        console.log(elem);
        console.log(elem.id);
        console.log(elementsById[elem.id]);
        if (elementsById[elem.id])
            return elem;
        console.log("strings:");
        console.log(StringStore(window.output.strings));
